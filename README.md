...
The CV generator works closely together with an instance of or a farm of _Project Server_ setups, another project of mine here, which provides, connects to, exctracts, decrypts and reformats the raw data appropriately.
